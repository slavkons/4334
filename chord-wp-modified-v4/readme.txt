...
Contributors: Slavomír Džubák, Lee Blue, Ján Paholík, Miroslav Ištvan
Donate link: https://4334.sk
...
See an example and learn [how to share your music with ChordWP!]
...
ChordWP uses the ChordPro music notation format to make it easy to put your chords and lyrics together.
...
* Special update for 4334.sk

= 1.1.1 = 

* Update the_content filter to check if is_main_query() to prevent duplicate content
* Resolve undefined index PHP notice for crd_save_song_nonce
